...
export default function Home() {
  ...
  <>     
      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center md:mx-auto" style={{border:"0px solid white"}}>
        ...
        <h1 className="md:text-[30px] md:ml-[-35%] md:mt-[-20%] font-bold" style={{border:"0px solid white"}}> Hunting </h1>

        <div className="relative md:w-[125px] md:h-[40px] md:ml-[34.5%] md:mt-[-22%]" style={{border:"0px solid yellow"}}> 
        ...
        <h1 className="font-medium font-mono md:mt-[1%] md:w-[110%] md:ml-[10%] md:text-[12px] underline underline-offset-[5px]" style={{border:"0px solid white"}}> Blogs for hunting coders by a hunting coder. </h1>
